...
?>
	...
	<table class="w100">
		<tr>
			<th colspan="3" class="centrar"><h1><?= cambiarAcentos(mb_strtoupper(_INDICEULTIMAJORNADA)) ?></h1></td>
		</tr>
<?php	
...
?>
		<tr>
			<td class="w20"><center><?php print($titulo);?></center></td>
			<td class="w60"><center><?php print($equipos);?></center></td>
			<td class="w20"><center><?php print($resultados);?></center></td>
		</tr>
<?php			
	}
...
?>
	...
	<table class="w100">
		<tr>
			<th colspan="3" class="centrar"><h1><?= cambiarAcentos(mb_strtoupper(_INDICEPROXIMAJORNADA)) ?></h1></td>
		</tr>
<?php	
...
?>
			<tr>
				<td class="w20"><center><?php print($titulo);?></center></td>
				<td class="w50"><center><?php print($equipos);?></center></td>
				<td class="w30"><center><?php print($fecha);?></center></td>
			</tr>
<?php			
	}
	mysqli_free_result($proximajornada);
